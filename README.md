...
## Installation
The project can be opened in Visual Studio by using 'Open a project or solution' and selecting the Project file, "158258 Assignment 3.sln" and running it as a local website using the default Run option (ILS Express (Google Chrome)).
